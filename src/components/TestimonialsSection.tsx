...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "El plomero llegó puntual y resolvió el problema rápidamente. Muy profesional y el precio fue justo. ¡Lo recomiendo totalmente!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Excelente servicio. El electricista identificó el problema que otros no pudieron encontrar. Trabajo limpio y eficiente.",
  },
  {
    name: "Ana Martínez",
    service: "Limpieza",
    rating: 4,
    comment:
      "El servicio de limpieza fue muy completo. Dejaron mi casa impecable y fueron muy respetuosos con mis pertenencias.",
  },
];
          ...
          <ScrollReveal variant="fade" delay={0}>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Miles de personas han encontrado profesionales de confianza a
                través de Sumee
              </p>
            </div>
          </ScrollReveal>
