...
const valuePillars = [
  {
    ...
    description: "Todos nuestros profesionales pasan por un riguroso proceso de verificación de 4 capas que garantiza tu seguridad y tranquilidad.",
    features: [
      { icon: faIdCard, text: "Verificación de INE/RFC con reconocimiento facial" },
      { icon: faShieldAlt, text: "Background check completo (antecedentes penales)" },
      { icon: faCertificate, text: "Certificaciones validadas con DC-3 y Red Conocer" },
      { icon: faUserTie, text: "Entrevista técnica y validación de experiencia" },
  ...
  },
  {
    icon: faShieldAlt,
    title: "Pagos Seguros",
    description: "Las transacciones se manejan fuera de la plataforma para máxima seguridad del cliente. Trabajamos con Stripe, el estándar mundial en pagos seguros.",
    features: [
      { icon: faLock, text: "Encriptación de Nivel Bancario (SSL/TLS)" },
      { icon: faCreditCard, text: "Tarifas claras y transparentes sin sorpresas" },
      { icon: faHandshake, text: "Liberación de pago solo al confirmar satisfacción" },
  ...
  },
  {
    ...
    description: "Sumee respalda cada trabajo con garantía financiera. Si algo sale mal, nosotros nos hacemos cargo sin preguntas ni complicaciones.",
    features: [
      { icon: faClock, text: "Garantía de 30 días (Estándar) o 90 días (Premium)" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ofrecemos la mejor experiencia para encontrar profesionales de confianza, 
            respaldada por garantías concretas y procesos verificables
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {valuePillars.map((pillar, index) => (
            <div 
              key={index} 
              className="bg-white p-6 md:p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col"
            >
              {/* Icono */}
