...
export default function ClientStatusPage() {
  ...
  const getStatusInfo = () => {
    if (!lead)
      return { icon: faClock, text: "Cargando...", color: "text-gray-500" };
    ...
    switch (estado) {
      case "nuevo":
        return {
          ...
          description:
            "Tu solicitud está siendo revisada por nuestros técnicos verificados.",
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-4">
            {error || "No se pudo encontrar tu solicitud"}
          </p>
          <button
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            ID de solicitud: #{leadId.slice(0, 8)}...
          </p>
        </div>

        {/* Status Card */}
        <div
          className={`${statusInfo.bgColor} ${statusInfo.borderColor} border rounded-xl p-6 mb-6`}
        >
          <div className="flex items-center space-x-4">
            <div
              className={`p-3 rounded-full ${statusInfo.bgColor} border ${statusInfo.borderColor}`}
            >
              <FontAwesomeIcon
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2 mt-2">
                  <div className="flex items-center">
                    {Array.from({ length: 5 }, (_, i) => {
                      const rating = lead.profiles?.calificacion_promedio ?? 5;
                      return (
                        <FontAwesomeIcon
                          key={i}
                          icon={faStar}
                  ...
                  <span className="text-sm text-gray-600">
                    ({(lead.profiles?.calificacion_promedio ?? 5).toFixed(1)} /
                    5.0)
                  </span>
                </div>
                ...
                {lead.profiles?.whatsapp && (
                  <a
                    href={`https://wa.me/${lead.profiles?.whatsapp?.replace(
                      /[^\d]/g,
                      ""
