...
import { AIRE_ACONDICIONADO_SERVICE_CONFIGS } from "@/config/service-forms/aire-acondicionado";

export default function AireAcondicionadoServicePage() {
  const router = useRouter();
  const params = useParams();
  let serviceSlug = params?.serviceSlug as string;

  const serviceConfig = AIRE_ACONDICIONADO_SERVICE_CONFIGS[serviceSlug];
