...
import { PLOMERIA_SERVICE_CONFIGS } from "@/config/service-forms/plomeria";

export default function PlomeriaServicePage() {
  const router = useRouter();
  const params = useParams();
  let serviceSlug = params?.serviceSlug as string;

  const serviceConfig = PLOMERIA_SERVICE_CONFIGS[serviceSlug];
