-- =====================================================
-- CORRECCIÓN: create_lead - convertir urgencia_ia a INTEGER
-- La columna urgencia_ia es de tipo INTEGER pero estamos insertando TEXT
-- =====================================================
...
-- PASO 2: Crear nueva versión con conversión correcta de urgencia_ia a INTEGER
...
BEGIN
  ...
  -- Log de éxito
  RAISE NOTICE 'create_lead: Lead creado exitosamente con ID: %, urgencia_ia: %', v_lead_id, v_urgencia_ia;
