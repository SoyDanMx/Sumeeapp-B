...
LANGUAGE plpgsql
SECURITY DEFINER  -- CRÍTICO: Ejecuta con permisos de superusuario, evita RLS
...
BEGIN
  ...
  SELECT 
    ...
    l.imagen_url,
    l.photos_urls,
    l.fecha_creacion,  -- Usar el nombre real de la columna
    l.updated_at
  FROM public.leads l
...
COMMENT ON FUNCTION public.create_lead_simple IS 
'Función RPC para crear leads de forma rápida. Usa SECURITY DEFINER para evitar problemas de RLS y permite crear leads sin esperar triggers bloqueantes.';
...
-- =========================================================================
-- NOTA: Los triggers seguirán ejecutándose, pero la función RPC
-- permite que el INSERT se complete rápidamente y los triggers
-- se ejecuten en background sin bloquear la respuesta
-- =========================================================================
