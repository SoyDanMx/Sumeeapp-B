-- =========================================================================
-- ACTUALIZACIÓN: Modificar función RPC create_lead para soportar precios sugeridos por IA
-- =========================================================================
-- Esta actualización agrega los parámetros ai_suggested_price_min y ai_suggested_price_max
-- a la función create_lead para guardar los precios sugeridos por la IA
-- =========================================================================

-- PASO 1: Eliminar la función existente
DROP FUNCTION IF EXISTS public.create_lead CASCADE;

-- PASO 2: Crear la nueva función RPC create_lead con precios sugeridos
CREATE FUNCTION public.create_lead(
  ...
  ai_suggested_price_min_in DECIMAL DEFAULT NULL,
  ai_suggested_price_max_in DECIMAL DEFAULT NULL
)
RETURNS UUID
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  VALUES (
    ...
    ai_suggested_price_min_in,
    ai_suggested_price_max_in,
    'nuevo',
...
Soporta priority_boost y precios sugeridos por IA (ai_suggested_price_min/max).';
